            ...
            if (temp.rNode.gVal > temp.gVal + 1) :
                ...
                for key in listOpen:
                    if key[1]==temp.rNode:
                        ...
                        ifRemove = 1
                        break
                f = temp.rNode.gVal + h_fun(temp.rNode,target)
                if ifRemove ==1:
            ...
            if (temp.lNode.gVal > temp.gVal + 1) :
                ...
                for key in listOpen:
                    if key[1]==temp.lNode:
                        ...
                        ifRemove = 1
                        break
                f = temp.lNode.gVal + h_fun(temp.lNode,target)
                if ifRemove ==1:
            ...
            if (temp.uNode.gVal > temp.gVal + 1) :
                ...
                for key in listOpen:
                    if key[1]==temp.uNode:
                        ...
                        ifRemove = 1
                        break
                f = temp.uNode.gVal + h_fun(temp.uNode,target)
                if ifRemove ==1:
            ...
            if (temp.dNode.gVal > temp.gVal + 1) :
                ...
                for key in listOpen:
                    if key[1]==temp.dNode:
                        ...
                        ifRemove = 1
                        break
                f = temp.dNode.gVal + h_fun(temp.dNode,target)
                if ifRemove ==1:
